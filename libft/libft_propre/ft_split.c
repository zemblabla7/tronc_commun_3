...
int    write_split(char **string, char *str, char c)
{
    ...
    while (word <= total_nb_of_words) // si je mets direct cla fx count_words ici alors ça deviendra de valeur 2 puis 1 au lieu de 3 car la valeur de str diminue à chaque boucle.
    {
